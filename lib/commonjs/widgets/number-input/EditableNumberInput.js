...
exports.CellNumberInputComponent = void 0;
...
function CellNumberInputComponent(props) {
    (0, react_native_1.useColorScheme)();
    var item = props.item;
    var _a = (0, EditableContext_1.useEditableCell)(), disabled = _a.disabled, value = _a.value, multiline = _a.multiline, updateField = _a.updateField, _b = _a.numberOfLines, numberOfLines = _b === void 0 ? 1 : _b;
...
exports.CellNumberInputComponent = CellNumberInputComponent;
