...
function DefaultCellAccessoryComponent(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, __assign({ style: {
        ...
        } }, { children: [accessoryType === 'disclosure' && ((0, jsx_runtime_1.jsx)(vector_icons_1.MaterialIcons, { name: "chevron-right", size: 22, color: (0, react_native_platform_color_1.PlatformColor)('systemGray5') })), accessoryType === 'checkmark' && ((0, jsx_runtime_1.jsx)(vector_icons_1.MaterialIcons, { name: "check", size: 20, style: { marginRight: 6 }, color: (0, react_native_platform_color_1.PlatformColor)('link') }))] })));
}
