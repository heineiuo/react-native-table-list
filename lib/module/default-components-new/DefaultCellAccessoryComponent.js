...
export function DefaultCellAccessoryComponent(props) {
    ...
    return (_jsxs(View, __assign({ style: {
        ...
        } }, { children: [accessoryType === 'disclosure' && (_jsx(MaterialIcons, { name: "chevron-right", size: 22, color: PlatformColor('systemGray5') })), accessoryType === 'checkmark' && (_jsx(MaterialIcons, { name: "check", size: 20, style: { marginRight: 6 }, color: PlatformColor('link') }))] })));
}
