...
export type TableListSection<SectionT extends Record<string, unknown>> =
  SectionT & {
    header?: string | JSX.Element
    footer?: string | JSX.Element
  }

export type TableListCellCustomComponentProps<
 ...
 * data[i]默认有的的字段
 */
export type TableListSectionDataItem<
  ItemT extends Record<string, unknown>,
  SectionT extends Record<string, unknown>
> = ItemT & {
  id?: string
   ...
   */
  CellImageComponent?: (
    info: TableListCellCustomComponentProps<ItemT, SectionT>
  ) => JSX.Element
  /**
   * 中间的主要部分
   */
   ...
   * 最右侧的部分
   */
  CellAccessoryComponent?: (
    info: TableListCellCustomComponentProps<ItemT, SectionT>
  ) => JSX.Element
}

export type TableListSections<
  ItemT extends Record<string, unknown>,
  SectionT extends Record<string, unknown>
> = SectionListData<
  TableListSectionDataItem<ItemT, SectionT>,
 ...
 *
 */
export type TableListPropsNew<ItemT extends Record<string, unknown>> = {
   ...
   */
  draggable?: boolean
} & Omit<DraggableFlatListProps<ItemT>, 'renderItem' | 'keyExtractor'> &
  Pick<Partial<DraggableFlatListProps<ItemT>>, 'keyExtractor'>
